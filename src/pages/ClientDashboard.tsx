...
export default function ClientDashboard() {
  ...
  const projects = [
    ...
    },
    {
      ...
      progress: 100,
      dueDate: '2024-11-20',
      description: 'Professional product photography shoot'
    },
    {
      id: 3,
      name: 'Brand Identity',
    ...
    },
    {
      ...
      progress: 0,
      dueDate: '2025-02-01',
      description: 'Product launch marketing video'
    }
  ]
              ...
              <div key={project.id} className="card p-6 hover:shadow-lg transition">
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center pt-4 border-t">
                  <div className="text-sm text-gray-600 mb-4 md:mb-0">
                    Due: <span className="font-bold text-gray-900">{new Date(project.dueDate).toLocaleDateString()}</span>
                  </div>
