        ...
        <div className="card p-8">
          ...
          <div className="mt-8 pt-8 border-t">
            ...
            <div className="space-y-2 text-sm text-gray-600">
              <p>Email: <span className="font-mono bg-gray-100 px-2 py-1">demo@example.com</span></p>
              <p>Password: <span className="font-mono bg-gray-100 px-2 py-1">demo123</span></p>
            </div>
          </div>
        </div>
