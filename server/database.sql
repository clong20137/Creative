...
CREATE TABLE IF NOT EXISTS SubscriptionPlans (
  ...
  productType ENUM('service', 'cms-license') DEFAULT 'service',
...
CREATE TABLE IF NOT EXISTS SiteSettings (
  ...
  googleSearchConsoleProperty VARCHAR(255),
  googleSearchConsoleServiceAccountJson LONGTEXT,
  pageSpeedUrl VARCHAR(255),
  pageSpeedApiKey VARCHAR(255),
