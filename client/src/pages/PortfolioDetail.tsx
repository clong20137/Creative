        ...
        {item && (
          <article className="max-w-5xl mx-auto bg-white rounded-lg shadow overflow-hidden">
            <SEO
              ...
              description={item.description || `A ${(document.documentElement.dataset.siteName || 'Creative by Caleb')} portfolio project for web design, photography, videography, or branding.`}
